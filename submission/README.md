<p align="center">
  <img src="assets/brand/labelhub-icon.svg" width="72" height="72" alt="LabelHub logo" />
</p>
...
| 层 | 技术 |
| --- | --- |
| 前端 | ![React](https://img.shields.io/badge/React_18-149ECA?logo=react&logoColor=white) ![TypeScript](https://img.shields.io/badge/TypeScript-3178C6?logo=typescript&logoColor=white) ![Ant Design](https://img.shields.io/badge/Ant_Design-1677FF?logo=antdesign&logoColor=white)<br/>Formily Schema 渲染、Zustand、@dnd-kit/core |
...
| 任务生产与管理 | 动态模板搭建 |
| --- | --- |
| <img src="assets/screenshots/02_owner_tasks.png" alt="任务管理" width="420" /> | <img src="assets/screenshots/04_owner_template_designer.png" alt="模板搭建器" width="420" /> |

| 标注工作台 | AI 预审队列 |
| --- | --- |
| <img src="assets/screenshots/07_labeler_workspace.jpeg" alt="标注工作台" width="420" /> | <img src="assets/screenshots/08_reviewer_ai_queue.jpeg" alt="AI 预审队列" width="420" /> |

| 人工审核工作台 | 导出中心 |
| --- | --- |
| <img src="assets/screenshots/10_reviewer_workbench.jpeg" alt="人工审核工作台" width="420" /> | <img src="assets/screenshots/05_owner_export_center.jpeg" alt="导出中心" width="420" /> |

更多页面截图见 `Demo截图/Demo截图说明.md`。
