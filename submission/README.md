...
| 任务生产与管理 | 动态模板搭建 |
| --- | --- |
| <img src="Demo截图/02_owner_tasks.png" alt="任务管理" width="420" /> | <img src="Demo截图/04_owner_template_designer.png" alt="模板搭建器" width="420" /> |

| 标注工作台 | AI 预审队列 |
| --- | --- |
| <img src="Demo截图/07_labeler_workspace.jpeg" alt="标注工作台" width="420" /> | <img src="Demo截图/08_reviewer_ai_queue.jpeg" alt="AI 预审队列" width="420" /> |

| 人工审核工作台 | 导出中心 |
| --- | --- |
| <img src="Demo截图/10_reviewer_workbench.jpeg" alt="人工审核工作台" width="420" /> | <img src="Demo截图/05_owner_export_center.jpeg" alt="导出中心" width="420" /> |
...
| 文档 | 路径 |
| --- | --- |
| 需求分析 | `基础技术文档/需求分析文档.md` |
| Demo 范围 | `基础技术文档/Demo范围文档.md` |
| 系统架构 | `基础技术文档/系统架构文档.md` |
| 数据库设计 | `基础技术文档/数据库设计文档.md` |
| API 文档 | `API文档.md` |
| 技术选型 | `基础技术文档/技术选型基线.md` |
| 开发计划 | `AI_Coding过程记录/开发粒度与实施计划.md` |
| 部署说明 | `演示环境说明/生产部署说明.md` |
